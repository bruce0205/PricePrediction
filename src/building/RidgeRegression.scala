...
object RidgeRegression {
  ...
  def build(sc: SparkContext): Unit = {
    ...
    val model: RidgeRegressionModel = RidgeRegressionWithSGD.train(trainingData, numIterations, stepSize, regParam, minBatchFraction) // infinite if without feature scaling
